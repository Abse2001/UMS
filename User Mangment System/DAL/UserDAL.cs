...
namespace User_Mangment_System.DAL
{
    public class UserDAL : DbHelper, IDisposable
    {
        public bool AddUser(User user)
        {
            ...
            string query = @"INSERT INTO Users (username, password_hash, role, failed_attempts, last_attempt, is_locked) 
        ...
        {
            string query = "SELECT username, password_hash, role, failed_attempts, last_attempt, is_locked FROM Users WHERE username = @Username";
            User user = null;
        ...
        public List<User> GetAllUsers()
        {
            ...
            string query = "SELECT username, password_hash, role, failed_attempts, last_attempt, is_locked FROM users";
